...
| Runtime verification | `docs/testing/results/V0.0.1-concrete-waymark-provider.md` | Dedicated 37.5/debit/refund runtime passed; prior provider-absent run retained |
