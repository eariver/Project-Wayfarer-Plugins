...
| BASE-002 | Add V0.0.1 API compatibility baseline | Exec. 6.3 | BASE-001 | TODO | Pending | None |
| BASE-003 | Audit scaffold, CI, reproducibility and package constraints | Exec. 6.1–6.2 | BASE-001 | IN_PROGRESS | Baseline notes in this ledger | None |
| REL-001 | Add correction-suffix grammar/order/docs/tests | Exec. 2.2, 8.1 | BASE-003 | TODO | Pending | None |
| CI-001 | Upgrade official Actions to Node 24 majors | Exec. 8.2 | BASE-003 | TODO | Official upstream action records | None |
| ADR-009 | Decide module persistence boundary | Exec. 7 | BASE-001 | PLUGIN_REVIEW_REQUIRED | `blocking-register.md` | B-001 |
| ADR-010 | Decide Core reuse/artifact release scope | Exec. 8.3 | ADR-009 | TODO | Pending | B-001 |
| REL-002 | Implement required scope-aware multi-artifact release/package path | Req. 16; Exec. 8.3 | ADR-010 | TODO | Pending | None |
| MAIN-001 | Main role/config/Core/lifecycle gate | Req. 8.1–8.4 | AUTH-002 | TODO | Pending | None |
| MAIN-002 | Growth Tool pure domain and threshold engine | Req. 8.5, 8.10–8.13 | MAIN-001 | TODO | Pending | None |
...
| FRONT-002 | Traversal/loadout/pending-delivery pure domain | Req. 11.4–11.8 | FRONT-001 | TODO | Pending | Navigation approval/client test |
...
| FRONT-005 | Launchpad domain/runtime/protection/reconcile | Req. 13 | FRONT-003 | TODO | Pending | FRONT-D03/D04; client test |
| FRONT-006 | Frontier shop transaction/delivery | Req. 14 | FRONT-002, FRONT-003 | TODO | Pending | FRONT-D06; client test |
...
| GIT-001 | Create/push initial foundation and Draft PR | Exec. 3.2–3.4 | AUTH-002 | IN_PROGRESS | This initial commit | GitHub push/PR |
