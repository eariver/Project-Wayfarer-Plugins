...
`WayfarerWaymarkProvider` is an adapter SPI, not a published runtime service. It uses stable
operation/reference IDs and explicit known/unknown effect classification. Concrete provider
availability remains governed by ADR 0006.
