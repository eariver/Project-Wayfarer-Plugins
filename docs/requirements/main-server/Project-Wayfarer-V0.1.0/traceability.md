...
| DB-017 | Restart recovery | 8.4 | Durable audit/player/item plus split-effect transaction recovery | Restart integration suite | alpha.2/4 | Pending | Automated test passed | DEBIT_PENDING and REFUND_PENDING MariaDB restart recovery passed |
