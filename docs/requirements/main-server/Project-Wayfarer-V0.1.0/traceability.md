...
| FND-015 | Reproducible artifact | 7 | Reproducible Shadow archive | Two clean build SHA-256 comparison | beta.1 | N/A | Automated test passed | Recheck for release version |
...
| FND-017 | API class identity preserved | 7, 10.1 | API contracts; Core service factory | `CoreRuntimeServicesTest` | beta.1 | Pending | Automated test passed | Runtime/packaging recheck pending |
| FND-018 | Runtime JAR excludes tests/secrets/runtime data | 7 | Core Shadow archive | JAR entry/config inspection | beta.1 | N/A | Automated test passed | Full beta scan pending |
...
| LIF-001 | Typed config validation | 8.1 | `CoreConfig`; `CoreConfigLoader` | `CoreConfigLoaderTest` | alpha.1 | Pending | Automated test passed | Runtime test pending |
| LIF-002 | Environment secret resolution | 8.1 | `EnvironmentSecretResolver`; `SecretValue` | Common/config secret tests | alpha.1 | Pending | Automated test passed | Runtime test pending |
...
| API-001 | `WayfarerServices` contract | 8.2 | Typed metadata/services contract | Service/API identity tests | beta.1 | Pending | Automated test passed | Full beta compatibility pending |
...
| API-008 | `WayfarerHealth` contract | 8.2 | Timestamped snapshot/component contract | Health/API identity tests | beta.1 | Pending | Automated test passed | Full beta compatibility pending |
...
| CFG-006 | Waymark provider settings | 8.3 | Typed inactive provider settings | Config validation suite | alpha.4 | Pending | Automated test passed | Capability probe deferred to alpha.4 |
| CFG-007 | Executor settings | 8.3 | Typed thread count/name | Range/name tests | alpha.1/3 | Pending | Automated test passed | Queue settings deferred to alpha.3 |
| CFG-008 | Audit settings | 8.3 | Typed enable flag | Valid config test | alpha.2 | Pending | Automated test passed | Persistence deferred to alpha.2 |
| CFG-009 | Health settings | 8.3 | Typed player detail flag | Valid config/command tests | alpha.1 | Pending | Automated test passed | Runtime command pending |
| CFG-010 | Shutdown timeout settings | 8.3 | Typed bounded duration | Range/timeout tests | alpha.1 | Pending | Automated test passed | Runtime timeout pending |
| CFG-011 | Sanitized sample | 8.3, 12 | Core `config.yml`; handoff | Secret/redaction tests | beta.1 | N/A | Automated test passed | Full beta asset scan pending |
| CFG-012 | No secret in Git/YAML | 8.3 | Environment references only | Secret/redaction tests | beta.1 | N/A | Automated test passed | Full history scan pending |
| CFG-013 | No secret in logs | 8.3 | Sanitized plugin diagnostics | Command/health redaction tests | beta.1 | Pending | Automated test passed | Runtime log inspection pending |
...
| CFG-015 | No secret in exceptions | 8.3 | Safe config/lifecycle exceptions | Failure/redaction tests | beta.1 | Pending | Automated test passed | Runtime inspection pending |
...
| ADM-001 | Health: Config/MariaDB/Migration | 8.10 | Config status; inactive dependencies `UNKNOWN` | Health aggregation/failure tests | alpha.1/2 | Pending | Automated test passed | Connectivity deferred to alpha.2 |
...
| ADM-004 | Health: Executor/Services | 8.10 | Dynamic executor/services components | Health/runtime tests | alpha.1/3 | Pending | Automated test passed | Runtime observation pending |
| ADM-005 | `/wayfarer admin health` | 8.10 | `HealthCommandHandler`; Bukkit adapter | Command suite | alpha.1 | Pending | Automated test passed | Runtime command pending |
...
| TST-007 | Failure/timeout tests | 10.1 | Lifecycle/executor failure suites | Gradle test | alpha.1+ | Pending | Automated test passed | Runtime failure tests pending |
| TST-008 | Restart recovery tests | 10.1 | phase plans | Automated suite | alpha.2+ | Pending | Not started | Implementation pending |
| TST-009 | Config validation tests | 10.1 | `CoreConfigLoaderTest` | Gradle test | alpha.1 | Pending | Automated test passed | Runtime config tests pending |
| TST-010 | Secret redaction tests | 10.1 | Common/config/health/command tests | Gradle test | beta.1 | Pending | Automated test passed | Runtime log test pending |
...
| TST-015 | Permission denial verification | 10.2 | Command permission suite | Gradle test | alpha.1/4 | Pending | Automated test passed | Runtime denial pending |
