...
| FND-015 | Reproducible artifact | 7 | Reproducible Shadow archive | Two clean build SHA-256 comparison | V0.0.1-alpha.1 / beta.1 | N/A | Automated test passed | Local and CI beta builds matched `81db587c3e283b478a06579d8785f3aa36e7d9307dc5198f2fd0ac26918a5b46` |
...
| LIF-008 | Waymark capability probe | 8.1 | JDK-only provider source, worker-thread probe, bounded startup recovery before publication | Provider fixture and MariaDB startup test | alpha.4 | Pending | Automated test passed | CI `30354268891`; concrete provider remains BLOCKED by ADR 0006 |
...
| DB-004 | Audit domain | 8.4 | V001 table plus durable repository | Idempotency/redaction/restart integration suite | alpha.2 | Pending | Automated test passed | Current-head CI `30354268891` |
| DB-005 | Player identity domain | 8.4 | Additive V002 and newer-only repository | Repository/restart integration suite | alpha.2 | Pending | Automated test passed | Current-head CI `30354268891` |
| DB-006 | Item identity domain | 8.4 | Additive V002 and async repository | Create/find/validate/restart suite | alpha.2 | Pending | Automated test passed | Current-head CI `30354268891` |
...
| DB-009 | Additive migration | 8.4 | V002 plus corrected pre-merge V003 | Empty/V001/V002-upgrade/repeated tests | alpha.2 | Pending | Automated test passed | V001/V002 unchanged; CI `30354268891` |
...
| DB-011 | UUID authority | 8.4 | Canonical UUID repositories and raw-claim gate | Unit/repository tests | alpha.2 | Pending | Automated test passed | MariaDB CI `30355673880` passed; Paper runtime pending |
...
| DB-015 | Required indexes | 8.4 | V001/V002 indexes plus V003 bounded recovery index | Information-schema inspection | alpha.2 | Pending | Automated test passed | Current schema/index inspection passed CI |
...
| DB-017 | Restart recovery | 8.4 | Durable audit/player/item plus split-effect transaction recovery | Restart integration suite | alpha.2/4 | Pending | Automated test passed | Identity repositories plus DEBIT_PENDING/REFUND_PENDING recovery passed in CI |
...
| TX-001 | Persist/recover PREPARED and DEBIT_PENDING | 8.5 | Stable debit operation plus V003 state/history | Crash/restart test | alpha.4 | Pending | Automated test passed | Persisted ID resolution; CI `30354268891` |
| TX-002 | Persist/recover DEBITED | 8.5 | Central state machine and repository | Crash/restart test | alpha.4 | Pending | Automated test passed | Recovery does not call provider |
| TX-003 | Persist/recover DOMAIN_COMMIT_PENDING and COMMITTED | 8.5 | Central state machine and repository | Crash/restart test | alpha.4 | Pending | Automated test passed | Both post-debit crash boundaries recover |
| TX-004 | Persist/recover REFUND_PENDING and REFUNDED | 8.5 | Stable refund operation and intended terminal state | Crash/restart test | alpha.4 | Pending | Automated test passed | APPLIED/NOT_APPLIED paths preserve debit |
| TX-005 | Persist/recover UNKNOWN and FAILED | 8.5 | Effect-specific resolution and fail-closed outcomes | State test | alpha.4 | Pending | Automated test passed | UNKNOWN resolution remains UNKNOWN |
| TX-006 | Persist RECONCILED_COMMITTED | 8.5 | Automatic/manual reconcile | Reconcile test | alpha.4 | Pending | Automated test passed | Persisted debit resolution used |
| TX-007 | Persist RECONCILED_REFUNDED | 8.5 | Claimed split-identity refund reconcile | Reconcile test | alpha.4 | Pending | Automated test passed | Refund operation/reference retained |
| TX-008 | Unique idempotency key | 8.5 | V001 unique key plus centralized exact full-input comparison | Idempotency test | alpha.4 | Pending | Automated test passed | Payload/subject type/nullable actor/restart mismatch fail closed |
| TX-009 | Prevent duplicate debit | 8.5 | PREPARED state claim plus recovery claim | Concurrency/restart test | alpha.4 | Pending | Automated test passed | Concurrent execute/recovery produced one debit |
| TX-010 | Prevent duplicate refund | 8.5 | Durable REFUND_PENDING operation and optimistic claim | Concurrency/restart test | alpha.4 | Pending | Automated test passed | Concurrent manual reconcile produced one refund |
| TX-011 | Detect crash windows | 8.5 | Failure injection at eight durable/effect boundaries | Failure injection | alpha.4 | Pending | Automated test passed | Operation/reference/history preserved at every boundary |
| TX-012 | Timeout behavior | 8.5 | Bounded provider completion/resolution | Timeout test | alpha.4 | Pending | Automated test passed | Before/after-effect timeout outcomes distinguished by resolution |
| TX-013 | Retry behavior | 8.5 | Existing result or persisted-operation resolution only | Retry test | alpha.4 | Pending | Automated test passed | Retry never invents a new operation ID |
| TX-014 | UNKNOWN handling | 8.5 | Explicit effect-specific UNKNOWN and no blind replay | Failure/recovery test | alpha.4 | Pending | Automated test passed | CI `30354268891` |
| TX-015 | Manual reconcile | 8.5 | Critical audit, safe state matrix, explicit action/confirm | Reconcile/command test | alpha.4 | Pending | Automated test passed | Illegal/terminal paths do not replay effects |
| TX-016 | Automatic reconcile | 8.5 | Structured provider resolution result | Restart/reconcile test | alpha.4 | Pending | Automated test passed | APPLIED/NOT_APPLIED/UNKNOWN covered; concrete provider blocked |
| TX-017 | Provider reference | 8.5 | Separate bounded debit/refund operation IDs and references | Schema/persistence/inspect test | alpha.4 | Pending | Automated test passed | Current V003 split metadata passed |
| TX-018 | Transaction audit | 8.5 | Atomic event authority plus degradable general mirror | Audit failure/atomic rollback tests | alpha.4 | Pending | Automated test passed | Mirror failure observable and cannot stop state progression |
| TX-019 | Transaction restart recovery | 8.5 | Bounded scan and durable recovery claim before publication | MariaDB restart/startup test | alpha.4 | Pending | Automated test passed | DEBIT_PENDING/REFUND_PENDING and startup publication ordering passed |
| TX-020 | Insufficient funds | 8.5 | Explicit provider fixture result | Provider fixture | alpha.4 | Pending | Automated test passed | Known failure; no debit effect/retry |
| TX-021 | Provider outage | 8.5 | Exception/timeout/structured UNKNOWN fixture result | Outage test | alpha.4 | Pending | Automated test passed | Provider-independent failure remains fail closed |
...
| AUD-002 | Audit health transitions/dependency outage | 8.6 | Dynamic Audit/Redis health plus transaction mirror degradation observer | Validation/failure/integration suite | alpha.2/3/4 | Pending | Automated test passed | Mirror failure warning sanitized; current CI `30354268891` |
...
| AUD-005 | Audit identity failures | 8.6 | Mandatory durable invalid-item and player-upsert-failure events | Unit/integration identity suite | alpha.2 | Pending | Automated test passed | CI `30355673880`; audit failure remains exceptional; Paper runtime pending |
| AUD-006 | Audit permission denial/shutdown timeout | 8.6 | Async durable permission sink plus bounded shutdown warning | Permission/timeout tests | alpha.2 | Pending | In progress | Permission persistence passed CI `30355673880`; shutdown-timeout durable record is not guaranteed |
...
| ID-001 | Player UUID authority | 8.7 | UUID-keyed player repository and join snapshot | Repository/restart tests | alpha.2 | Pending | Automated test passed | MariaDB CI `30355673880`; Paper runtime pending |
| ID-002 | Last-known name is auxiliary only | 8.7 | Non-unique indexed name; stale update ignored | Repository tests | alpha.2 | Pending | Automated test passed | MariaDB CI `30355673880`; Paper runtime pending |
...
| TST-001 | Unit tests | 10.1 | API/Common/Core test sources | State/engine/provider-source/recovery/API-shape suite | V0.0.1-alpha.1+ | N/A | Automated test passed | 169 passed, 0 failed, 0 skipped; CI `30355673880` |
| TST-002 | MariaDB integration | 10.1 | Testkit fixture; mandatory Core integration task | Migration, atomic history, recovery and restart suite | alpha.2+ | Pending | Automated test passed | 14 passed, 0 failed, 0 skipped in GitHub-hosted isolated Testcontainers; CI `30355673880` |
| TST-003 | Redis integration | 10.1 | `redisIntegrationTest` using authoritative `redis:8-alpine` | Testcontainers regression suite | alpha.3+ | Pending | Automated test passed | Six cases passed in CI `30355673880`; Paper runtime remains pending |
| TST-004 | Migration tests | 10.1 | Immutable V001/V002 plus corrected pre-merge V003 | Empty/V001/V002 upgrade, repeat and schema identity tests | alpha.2+ | Pending | Automated test passed | Corrected V003 SHA-256/blob recorded; CI `30354268891` |
| TST-005 | Concurrency tests | 10.1 | Optimistic transaction/recovery claims and identity semantics | Concurrent idempotency, recovery-claim and manual-refund race tests | alpha.2+ | Pending | Automated test passed | Unit and MariaDB concurrency cases passed; CI `30354268891` |
| TST-006 | Idempotency tests | 10.1 | Exact full-input comparison with persisted debit/refund operation identity | Unit concurrency plus MariaDB restart suite | alpha.4 | Pending | Automated test passed | Nullable actor, subject, payload and restart mismatch cases passed; CI `30354268891` |
...
| TST-008 | Restart recovery tests | 10.1 | Bounded startup recovery before provider-dependent publication | MariaDB PREPARED/DEBIT_PENDING/REFUND_PENDING restart suite | alpha.2+ | Pending | Automated test passed | Split effect identity and safe provider-resolution cases passed; CI `30354268891` |
...
| TST-015 | Permission denial verification | 10.2 | Async operational audit sink with actor snapshot | Unit/MariaDB permission tests | V0.0.1-alpha.1 / alpha.4 | alpha.1 runtime evidence | In progress | Unit and durable MariaDB CI `30355673880` passed; later Paper admin commands pending |
