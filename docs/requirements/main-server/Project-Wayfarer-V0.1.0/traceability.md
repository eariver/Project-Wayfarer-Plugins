...
| TST-001 | Unit tests | 10.1 | API/Common/Core test sources | State/engine/provider-source/recovery suite | V0.0.1-alpha.1+ | N/A | Automated test passed | 167 passed, 0 failed, 0 skipped; CI `30354268891` |
| TST-002 | MariaDB integration | 10.1 | Testkit fixture; mandatory Core integration task | Migration, atomic history, recovery and restart suite | alpha.2+ | Pending | Automated test passed | 14 passed, 0 failed, 0 skipped in GitHub-hosted isolated Testcontainers; CI `30354268891` |
| TST-003 | Redis integration | 10.1 | `redisIntegrationTest` using authoritative `redis:8-alpine` | Testcontainers regression suite | alpha.3+ | Pending | Automated test passed | Six cases passed in CI `30354268891`; Paper runtime remains pending |
