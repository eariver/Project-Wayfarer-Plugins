­r‡^Ñf¥–Ø¦{OlyÊ'vÃ®¶›­# V0.0.2 Requirement Traceability
...
| Core compatibility and migrations | Core API, V001â€“V003 | Compatibility and immutable migration tests | None required here | `DONE` | Core V0.0.1 is reused unchanged. |
...
| EMâ€“MVI adapter | No module or artifact | Absence checks | Project decision required | `DEFERRED_BY_REQUIREMENT` | Create only after `ADAPTER_REQUIRED`. |
